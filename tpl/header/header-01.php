...
if (themesflat_get_opt_elementor('header_info_phone_text') != '') {
    $header_info_phone_text = themesflat_get_opt_elementor('header_info_phone_text');
}
                        ...
                        <?php if ( $header_infor_phone == 1 ) :?>
                                <div class="phone-header-box">
                                    <div class="inner">
                                        ...
                                        <h3><?php echo esc_attr($header_info_phone_number); ?></h3>
                                    </div>
                                </div>
                        <?php endif; ?>
                            </div>
