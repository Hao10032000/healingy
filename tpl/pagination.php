...
$links = paginate_links( array(
	...
	'prev_text' => ( '<i class="icon-autodeal-angle-left"></i>' ),
	'next_text' => ( '<i class="icon-autodeal-angle-right"></i>' ),
) );
...
$next_link = get_next_posts_link( esc_html__( 'Next', 'healingy' ) );
$prev_link = get_previous_posts_link( esc_html__( 'Previous', 'healingy' ) );
$loadmore_text = apply_filters('themesflat/template/loadmore_text',esc_html__('Load More','healingy'));
