...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Heading ( OFF | ON )', 'healingy'),
...
$wp_customize->add_control( new themesflat_Info( $wp_customize, 'page-title-style', array(
    'label' => esc_html__('Page Title Style', 'healingy'),
    'section' => 'section_page_title',
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'label'         => esc_html__('Page Title Style', 'healingy'),
        'choices'   => array (
            'inline' =>  esc_html__( 'Inline Heading & Breadcrumbs','healingy' ),
            'default' =>  esc_html__( 'Default','healingy' ),
            'video' =>  esc_html__( 'Video','healingy' )
            ) ,
    )
);
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'section'   => 'section_page_title',
        'priority'  => 22,
        'label'         => esc_html__('Page Title Alignment', 'healingy'),
        'choices'   => array (
            'left' =>  esc_html__( 'Left','healingy' ),
            'center' =>  esc_html__( 'Center','healingy' ),
            'right' =>  esc_html__( 'Right','healingy' )
            ) ,
    )
); 
...
$wp_customize->add_control(
    new WP_Customize_Image_Control(
        ...
        'page_title_background_image',
        array(
           'label'          => esc_html__( 'Upload Background Image', 'healingy' ),
           'type'           => 'image',
           'section'        => 'section_page_title',
           'priority'       => 23,
        )
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'section'   => 'section_page_title',
        'priority'  => 24,
        'label'         => esc_html__('Page Title Image Size', 'healingy'),
        'choices'   => array (
            'auto' =>  esc_html__( 'Original','healingy' ),
            'contain' =>  esc_html__( 'Fit to Screen','healingy' ),
            'cover' =>  esc_html__( 'Fill Screen','healingy' )
            ) ,
    )
);
...
$wp_customize->add_control(
    ...
    array(
        'type'      => 'text',
        'label'     => esc_html__('Page Title Background Video URL', 'healingy'),
        'section'   => 'section_page_title',
        'priority'  => 25
    )
);
...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        'page_title_background_color',
        array(
            'label'         => esc_html__('Background Color', 'healingy'),
            'section'       => 'section_page_title',
            'priority'      => 26
        )
    )
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    'page_title_controls',
    array(
        'label' => esc_html__( 'Page Title Controls (px)', 'healingy' ),
        'section' => 'section_page_title',
        'type' => 'box-controls',
        'priority' => 28
    ))
