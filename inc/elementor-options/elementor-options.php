...
class themesflat_options_elementor {
    ...
    public function themesflat_options_services($element) {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => esc_html__('TF Services', 'healingy'),
                'tab' => Controls_Manager::TAB_SETTINGS,
            ]
        );
        ...
        $element->add_control(
            ...
            [
                'label'     => esc_html__( 'Services Post', 'healingy'),
                'type'      => Controls_Manager::HEADING,
            ]
        );
        ...
        $element->add_control(
            'services_post_icon',
            [
                'label' => esc_html__( 'Post Icon Style 1', 'healingy' ),
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Post Icon Image Style 2', 'healingy' ),
    ...
    public function themesflat_options_portfolio($element) {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => esc_html__('TF Portfolio', 'healingy'),
                'tab' => Controls_Manager::TAB_SETTINGS,
            ]
        );
        ...
        $element->add_control( 
            'show_author',
            [
                'label' => esc_html__( 'Show Author', 'themesflat-core' ),
        ...
        $element->add_control(
            'text_author',
            [
                'label' => esc_html__( 'Text Author', 'healingy' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Clients', 'healingy' ),
                'label_block' => true,
                'condition' => [
                    'show_author' => 'yes'
                ],
        ...
        $element->add_control(
            'text_date',
            [
                'label' => esc_html__( 'Text Date', 'healingy' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Date', 'healingy' ),
                'label_block' => true,
                'condition' => [
                    'show_date' => 'yes'
                ],
        ...
        $element->add_control(
            'text_category',
            [
                'label' => esc_html__( 'Text Category', 'healingy' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Services', 'healingy' ),
                'label_block' => true,
                'condition' => [
                    'show_category' => 'yes'
                ],
        ...
        $element->add_control( 
            'show_custom',
            [
                'label' => esc_html__( 'Show Custom Infor', 'themesflat-core' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'themesflat-core' ),
                'label_off' => esc_html__( 'Hide', 'themesflat-core' ),
                'return_value' => 'yes',
        ...
        $element->add_control(
            'text_custom',
            [
                'label' => esc_html__( 'Label Custom Infor', 'healingy' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Clients', 'healingy' ),
                'label_block' => true,
                'condition' => [
        ...
        $element->add_control(
            'text_custom_infor',
            [
                'label' => esc_html__( 'Text Custom Infor', 'healingy' ),
                'type' => Controls_Manager::CODE,
                'default' => 'Custom',
                'label_block' => true,
                'condition' => [
        ...
        $element->add_control(
            'h_options_nav_portfolio',
            [
                'label' => esc_html__( 'Heading & Description', 'healingy' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $element->add_control(
            'portfolio_infor_title',
            [
                'label' => esc_html__( 'Title Infor', 'healingy' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Project Information', 'healingy' ),
                'label_block' => true,
            ]
        );

        $element->add_control(
            'portfolio_infor_title_ctr',
            [
                'label' => esc_html__( 'Title Content', 'healingy' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Hendrerit libero, sit amet hendrerit elit turpis nec velit. Praesent tincidunt nisi at vulputate ornare', 'healingy' ),
                'label_block' => true,
            ]
        );
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Description Content', 'healingy' ),
                'type' => \Elementor\Controls_Manager::WYSIWYG,
                'default' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae metus a massa lobortis sollicitudin. Cras ut nulla quam. Maecenas tempus felis quis lorem malesuada vehicular.
                Morbi commodo, eros quis consequat consequat, orci lacus auctor ligula, ut maximus arcu sapien nec elit. Suspendisse rutrum elit at urna dapibus viverra. Etiam lectus libero, condimentum eget justo ac, accumsan suscipit libero.
